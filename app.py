...
# =========================================================
# 0. CONFIGURAZIONE & CSS (FOCUS: ICONE GRANDI)
# =========================================================
...
<style>
    ...
    /* ============================================================
       KPI CARDS (I 4 PULSANTONI IN ALTO)
       ============================================================ */
    
    /* 1. IL CONTENITORE DEL PULSANTE */
    div[data-testid="column"] button {
        background-color: #1e232e !important;
        border: 1px solid rgba(255,255,255,0.1) !important;
        border-radius: 16px !important;
        height: 160px !important; /* ALTEZZA FORZATA */
        width: 100% !important;
    ...
    /* 2. IL TESTO DENTRO IL PULSANTE (Icona + Numero + Label) */
    /* Usiamo un selettore molto specifico per vincere su Streamlit */
    div[data-testid="column"] button p {
        font-size: 45px !important; /* DIMENSIONE ICONA ENORME */
        font-weight: 800 !important;
    ...
    /* 3. COLORI BORDI LATERALI (Per distinguerli) */
    div[data-testid="column"]:nth-of-type(1) button { border-left: 8px solid #4299e1 !important; } /* Blu */
    div[data-testid="column"]:nth-of-type(2) button { border-left: 8px solid #e53e3e !important; } /* Rosso */
    div[data-testid="column"]:nth-of-type(3) button { border-left: 8px solid #ed8936 !important; } /* Arancio */
    div[data-testid="column"]:nth-of-type(4) button { border-left: 8px solid #38b2ac !important; } /* Verde */


    /* ============================================================
       PULSANTI AZIONE PICCOLI (Quelli dentro le liste o alert)
       ============================================================ */
    /* Resettiamo lo stile per i bottoni che sono DENTRO un container verticale (gli alert) */
...
with st.sidebar:
    ...
    st.divider()
    st.caption("Focus App v3.9 - Big Icons")
...
if menu == "⚡ Dashboard":
    ...
    if not df.empty:
        ...
        # 1. RIGA KPI (ICONE GIGANTI 45px+)
        col1, col2, col3, col4 = st.columns(4)
        
        # Testo formattato: Icona - Spazio - Numero - A Capo - Etichetta
