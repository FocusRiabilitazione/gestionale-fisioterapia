...
# --- NUOVA FUNZIONE GENERAZIONE HTML (Stile Moderno + Logo Centrato) ---
def generate_html_preventivo(paziente, data_oggi, note, righe_preventivo, totale_complessivo, logo_b64=None, auto_print=False):
    ...
    # CSS Aggiornato per Stile "Aldegonda Pozzi"
    return f"""
    <!DOCTYPE html>
    <html lang="it">
    <head>
        ...
        <style>
            ...
            .doc-brand-main {{ font-size: 30px; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; }}
            ...
            /* Obiettivi */
            .obj-box {{ 
                background-color: #f9f9f9; border-left: 4px solid #2c3e50; 
...
with st.sidebar:
    ...
    st.divider(); st.caption("App v58 - Final Print Style")
