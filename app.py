...
# --- FUNZIONE HTML PDF (LAYOUT A4 PULITO SENZA INTESTAZIONI BROWSER) ---
    ...
    <head>
        ...
        <style>
            ...
            @media print {{
                @page {{ 
                    size: A4; 
                    margin: 0; /* RIMUOVE INTESTAZIONI BROWSER (Data, URL, Titolo pagina) */
                }}
                body {{ 
                    margin: 0; 
                    padding: 0; 
                ...
                .sheet-a4 {{ 
                    width: 210mm;
                    height: 296mm; /* Forziamo altezza per stare in 1 pag (297 - 1mm) */
                    margin: 0; 
                    box-shadow: none; 
                    border: none; 
                    page-break-after: avoid; 
                    page-break-inside: avoid;
                    overflow: hidden; /* Taglia eventuali sbavature */
                }}
            }}
            ...
            /* Header Centrato */
            .logo-img {{ max-width: 160px; height: auto; display: block; margin: 0 auto 5px auto; }}
            .brand-text-container {{ text-align: center; margin-bottom: 20px; }}
            .doc-brand-main {{ font-size: 28px; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; color: #000; }}
...
with st.sidebar:
    ...
    st.divider(); st.caption("App v63 - Final Print No Headers")
